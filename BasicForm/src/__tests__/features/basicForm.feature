...
Scenario: Input error when leaving a section incompleted
    ...
    And the user selects the "name" section
    Then the "username" section should show show error

Scenario: User is unable to input a username longer than 10 character
    Given the user selects the "username" section
    And the user types "PEPELOQUETE"
    Then the "username" section should show "PEPELOQUET"
...
Scenario: Id validation failed
    ...
    Then the "id" section should show "ERROR"
...
Scenario: Id validation failed
    ...
    Then the "id" section should show "Confirm"
